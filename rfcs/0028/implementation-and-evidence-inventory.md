...
| `openclaw/openclaw` macOS adopter PR #149725 | `d1ac57f8fd9` | Draft, stacked on #150344; helper, Swift adapter, package/signing integration, proxy-safe routing, and native probes |
...
| macOS adopter | #149725 `d1ac57f8fd9` | Focused helper/adapter stack with authenticated IPC, exact JSON, native admission, TLS, cancellation, saturation, proxy/PAC fallback, packaging, signing, and probe harnesses; probe scripts pass formatter, linter, syntax, and cleanup-flow review | Exact-head disposable-macOS install/upgrade/rollback and functional/performance proof remains required |
