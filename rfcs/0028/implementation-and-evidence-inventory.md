...
| `openclaw/openclaw` conformance PR #150329 | `232a5d851d9` | Open; permanent bilateral TypeScript/Rust lifecycle and authority gate |
...
| `openclaw/openclaw` macOS adopter PR #149725 | `291f0fdcdfa` | Draft, stacked on #150344; helper, Swift adapter, package/signing integration, proxy-safe routing, and native probes |
...
| Permanent conformance gate | #150329 `232a5d851d9` | 140 locked Rust tests, 166 focused TypeScript contract/registry tests, 639 workflow-guard tests, strict Rust static gates and formatting | Hosted dependency-download and unrelated compact/UI failures are rerunning; exact-head checks must remain green as either implementation evolves |
| Reusable native seams | #150344 `a97e9bdba67` | 148 Rust tests and strict static gates; review found no significant issue after hostname-bound trust, fair control-channel, declaration/member Periphery retention, and SwiftLint fixes | Final hosted Swift/macOS proof is running |
| macOS adopter | #149725 `291f0fdcdfa` | Focused helper/adapter stack with authenticated IPC, exact JSON, native admission, TLS, cancellation, saturation, proxy/PAC fallback, packaging, signing, and probe harnesses; probe scripts pass the complete repository script-lint shard, formatter, syntax, and cleanup-flow review | Exact-head disposable-macOS install/upgrade/rollback and functional/performance proof remains required |
